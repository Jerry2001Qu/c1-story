...
from src.prompts import get_sot_prompt, reformat_prompt, sot_prompt, parse_prompt, section_summary_prompt, facts_prompt
    ...
    if st.session_state["run"]:
        with st.status("Running"):
            if not st.session_state["ran"]:
                ...
                facts_raw = facts_chain.invoke({"SCRIPT": story, "SHOTLIST": shotlist}).content
                facts_xml = extract_xml(facts_raw)
                facts = facts_xml['response']
