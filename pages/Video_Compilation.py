    ...
    if st.session_state["run"]:
        ...
        with st.status("Running", expanded=True):
            if not st.session_state["ran"]:
                ...
                clip_manager = ClipManager(video_file_path, clips_folder, shotlist, Path("./assets/anchor-default.png"), anchor_voice_id, voiceover_voice_id, error_handler=error_handler)
